...
export default class OrderDeatilController implements Controller {
    ...
    private initializeRoutes() {
        ...
        this.router.get(`${this.path}/:offset/:limit/:OrderDetail/:sort/:keyword?`, this.getPaginatedOrderDetails);
